...
vim.keymap.set("n", "<leader>fg", ":lua require('telescope').extensions.live_grep_args.live_grep_args()<cr>", { desc = "Grep args" })
...
vim.keymap.set("n", "mm", ":lua require('bookmarks').bookmark_toggle()<cr>", { desc = "add or remove bookmark at current line" })
vim.keymap.set("n", "mc", ":lua require('bookmarks').bookmark_clean()<cr>", { desc = "clean all marks in local buffer" })
vim.keymap.set("n", "mi", ":lua require('bookmarks').bookmark_ann()<cr>", { desc = "add or edit mark annotation at current line" })
