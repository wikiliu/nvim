...
vim.keymap.set("n", "<leader>fg", "<cmd>lua require('telescope').extensions.live_grep_args.live_grep_args()<cr>", { desc = "Grep args" })
...
vim.keymap.set("n", "mm", "<cmd>lua require('bookmarks').bookmark_toggle()<cr>", { desc = "add or remove bookmark at current line" })
vim.keymap.set("n", "mc", "<cmd>lua require('bookmarks').bookmark_clean()<cr>", { desc = "clean all marks in local buffer" })
vim.keymap.set("n", "mi", "<cmd>lua require('bookmarks').bookmark_ann()<cr>", { desc = "add or edit mark annotation at current line" })
vim.keymap.set("n", "mn", "<cmd>lua require('bookmarks').bookmark_next()<cr>", { desc = "jump to next mark in local buffer" })
vim.keymap.set("n", "mp", "<cmd>lua require('bookmarks').bookmark_prev()<cr>", { desc = "jump to previous mark in local buffer" })
vim.keymap.set("n", "ml", "<cmd>lua require('bookmarks').bookmark_list()<cr>", { desc = "show marked file list in quickfix window" })
